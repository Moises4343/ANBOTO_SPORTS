...
export class GenerateMatchesController {
    constructor(readonly useCase: GenerateMatchesUseCase, readonly service: TokenService) {}
    ...
    execute: RequestHandler = async (req: Request, res: Response) => {
        try {
            ...
            res.status(200).json({ message: "Partidos generados correctamente." });
        } catch (error: any) {
